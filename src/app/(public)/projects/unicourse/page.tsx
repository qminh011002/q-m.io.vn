...
export default function UnicoursePage() {
	return (
		<div className="animate-raise">
			<HeaderProject
				hrefProject="https://github.com/FPTU-s-Friends"
				role="Front-end & Mobile Developer"
				title="UniCourse - FPT Learning Platform "
				description="A startup providing web and mobile access to university courses, specifically catering to FPT University students with a short-term focus"
				time="2024 - 2025"
			/>
			<h3
			...
			>
				<Linksource
					...
					content="Unicourse.vn"
				/>{' '}
				is a dynamic e-learning platform that empowers students with
				personalized courses, progress tracking, and interactive
				learning experiences. The iOS version is specifically optimized
				for Apple devices, delivering a seamless, high-performance
				experience with enhanced accessibility and responsiveness.
			</p>
			<FigureComponent
				height={400}
				caption=""
				imageSrc="/projects/unicourse/unicoursetech.png"
				altText="Tablet view of the dashboard home page. The application is
								designed to be responsive to all platforms and devices."
			/>
			<p className="mt-5 leading-7 text-primary">
				Crafted with a user-centric approach, Unicourse provides a
				seamless and intuitive interface, making online learning more
				accessible and effective.
			</p>
			<ul className="mt-6 flex flex-col gap-2">
				<h4 className="font-bold">Technologies in use</h4>
				<li className="flex items-center gap-1 text-primary">
					<Dot size={30} color="currentColor" />
					<strong className="font-semibold text-primary">
						Mobile:
					</strong>
					Android using React Native - Typescript and iOS using
					SwiftUI - Swift
				</li>
				<li className="flex items-center gap-1 text-primary">
					<Dot size={30} color="currentColor" />
					...
					Admin using React - MUI - Typescript and Client using
					Angular - PrimeNG
				</li>
			</ul>
			...
			<FigureComponent
				padding={2}
				height={550}
				caption="Web applicaiton view"
				imageSrc="/projects/unicourse/macbookuni.png"
			...
			<p className="mt-2 leading-7 text-secondary">
				...
				is built using a modern and scalable technology stack to deliver
				a seamless learning experience across multiple platforms. The
				mobile application is developed with React Native for Android
				and Swift/SwiftUI for iOS, ensuring optimal performance and a
				native-like experience on both operating systems. On the web,
				React.js and Angular power the frontend, providing an intuitive
				and responsive user interface. The backend is built with
				Node.js, handling real-time interactions, data processing, and
				API communication efficiently. This combination of technologies
				ensures that Unicourse remains a high-performance, dynamic, and
				interactive e-learning platform tailored to students needs.
			</p>
			<div className="my-16">
			...
			<FigureComponent
				padding={2}
				height={550}
				caption="Our social information"
				imageSrc="/projects/unicourse/mac-uni.png"
				altText="Product lifecycle stages for environmental impact assessment"
			/>
